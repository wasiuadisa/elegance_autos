...
@section('preTitle') Used vehicles in stock @endsection
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                      ...
                      <li class="active">Used vehicles in stock</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
              ...
              @foreach ($vehicles as $auto)
                ...
                @endif
                  ...
                  @if($auto->sold == 0)
                    <a href="{{ route('postSold', [$auto->id, 'posts']) }}" class="btn btn-success btn-sm">
                      Mark as Sold
                    </a>
                  @else
                  ...
                  @endif
                  @if($auto->delete == 0)
                    <a href="{{ route('postDelete', [$auto->id, 'posts']) }}" class="btn btn-danger btn-sm">
                      Delete 
                    </a>
                  @endif
                  </td>
