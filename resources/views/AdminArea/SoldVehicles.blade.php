...
@section('preTitle') Sold vehicles @endsection
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                      ...
                      <li class="active">Sold vehicles</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
              ...
              @foreach ($vehicles as $auto)
                ...
                @endif
                  ...
                  @if($auto->sold == 0)
                    <a href="{{ route('postSold', [$auto->id, 'soldCars']) }}" class="btn btn-success btn-sm">
                      Mark as Sold
                    </a>
                  @else
                  ...
                  @endif
                  @if($auto->delete == 0)
                    <a href="{{ route('postDelete', [$auto->id, 'soldCars']) }}" class="btn btn-danger btn-sm">
                      Delete 
                    </a>
                  @endif
                  </td>
