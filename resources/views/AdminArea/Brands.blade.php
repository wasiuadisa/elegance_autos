...
@section('preTitle') All vehicles brands @endsection
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">Vehicles Brands </li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
              ...
              @foreach ($vehicles as $auto)
                <tr style="background-color: White;">
                  <td class="col-md-3">
                    <a href="{{ route('editCarBrandForm', [$auto->id,]) }}">
                      {{ ucfirst(htmlspecialchars_decode($auto->name)) }}
                    </a>
                  </td>
                  <td class="col-md-3" style="padding-top: -10px;">
                    <a href="{{ route('editCarBrandForm', [$auto->id,]) }}" class="btn btn-success btn-sm">
                      Edit
                    </a>
                  @if($auto->delete == 0)
                    <a href="{{ route('brandDelete', [$auto->id,]) }}" class="btn btn-danger btn-sm">
                      Delete 
                    </a>
                  @endif
                  </td>
