...
@section('preTitle') Edit Event Image Form @endsection
...
<div class="container">
  ...
  @endif
    ...
    <form class="form-group" enctype="multipart/form-data" method="post" action="{{ route('editEventImageFormData', [ $ImageId ]) }}">
      <table class="table">
        <tbody>
          ...
          <tr>
            <td colspan="2" class="col-lg-offset-2 col-lg-8">
              <img src="{{ asset('Events/' . $image->disk_image_filename) }}" class="col-lg-12" />
            </td>
          </tr>
        ...
        @if( session('infoStatus') == 'Good Job! The event photo has been replaced, successfully.' )
          <tr class="form-group" style="background-color: White;">
            <td colspan="2">  
              <a href="{{ route('eventView', [ $event_id,]) }}" class="btn btn-primary">
