...
@section('preTitle') New Vehicle Image Form @endsection
...
<div class="container">
          ...
          <div class="page-header float-right">
              <div class="page-title">
                  <ol class="breadcrumb text-right">
                      ...
                      <li class="active">New Car post image</li>
                  </ol>
              </div>
          </div>
      </div>
  ...
  @endif
    ...
    <form class="form-group" enctype="multipart/form-data" method="post" action="{{ route('newCarImageFormData') }}">
      <table class="table">
        <tbody>
        ...
        @if( session('infoStatus') == 'Good Job! The new car post photo has been uploaded, successfully.' )
          <tr class="form-group" style="background-color: White;">
            <td colspan="2">  
