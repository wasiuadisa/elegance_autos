...
?>
                ...
                <li>
                    <div class="preview">
                        ...
                        <img src="{{ asset('VehiclesInStock/images') . '/' . 'defaultImage.jpg' }}" alt="No photo">
                        @else
                        <img src="{{ asset('VehiclesInStock/images') . '/' . $imageFilename->disk_image_filename }}" alt="{{ ucfirst($imageFilename->caption) . ' | ' . $recent->title }}">
                        @endif
